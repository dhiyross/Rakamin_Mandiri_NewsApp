...
import com.example.rakamin_mandiri_newsapp.databinding.FragmentHomeBinding
import com.example.rakamin_mandiri_newsapp.ui.NewsActivity
import com.example.rakamin_mandiri_newsapp.ui.NewsViewModel
import com.example.rakamin_mandiri_newsapp.util.Constants
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemHomeError = view.findViewById(R.id.itemHeadlinesError)
        ...
        newsViewModel.everything.observe(viewLifecycleOwner, Observer { response ->
            when(response){
                is Resource.Success<*> -> {
                    hideProgressBar()
                    hideErrorMessage()
                    response.data?.let {newsResponse ->
                        ...
                        isLastPage= newsViewModel.everythingSection == totalPages
                        if(isLastPage){
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        private fun setupEverythingRecycler(){
